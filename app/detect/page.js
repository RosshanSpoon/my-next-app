...
export default function Detect() {
  ...
  return (
    ...
    >
      ...
      {/* Main Content */}
      <div className="flex flex-col lg:flex-row items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 px-4 gap-8">
        ...
        <div className="w-full max-w-lg bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
          ...
          <p className="mt-4 text-center text-gray-600 dark:text-gray-300">
            Upload an image to detect AI-generated content.
          </p>
        ...
        <div className="w-full max-w-lg bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
          ...
          <p className="mt-4 text-center text-gray-600 dark:text-gray-300">
            Enter text to detect AI-generated content.
          </p>
  
          <textarea
            className="w-full p-4 border rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-white mt-6"
            rows="4"
          ...
          />
          <button
            className="mt-4 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none w-full"
